...
function QueEs() {
  return (
    <main style={{ backgroundColor: "black" }}>
      <article className="container px-5" id="que-es">
        <section className="row d-flex align-items-center">
          ...
          >
            ...
            <p>
              <br />
              Es una plataforma de notas simplificada, pensada para
              programadores.
              <br /> <br />
              Te permite organizar tus ideas y proyectos de forma ágil, con
              funciones útiles como snippets de código, etiquetas y una
              estructura clara para mantener el foco en lo importante. <br />{" "}
              <br /> Perfecta para tareas simples o para desarrollar proyectos
